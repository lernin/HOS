...
- Finger drag offset is `LOGYQPreview.gestures.fingerOffset()`. Up is **1.75cm**, side **0**, at 38px/cm (`{x:0,y:-66.5}` for both handedness settings). Mouse path must not use it.
