  function injectStyles() {
    ...
    style.textContent = `
      ...
      @media (max-width:700px), (pointer:coarse) and (max-width:1200px), (hover:none) and (max-width:1200px){
        ...
        #Dock,#Dock.dock-left{box-sizing:border-box;left:8px;right:8px;top:auto;bottom:max(8px,env(safe-area-inset-bottom));width:auto;height:56px;min-height:56px;max-height:56px;padding:6px 8px;overflow-x:auto;overflow-y:hidden;display:flex!important;flex-direction:row;flex-wrap:nowrap;justify-content:flex-start;align-items:center;column-width:auto;column-count:auto;gap:8px;border-radius:16px;background:rgba(255,255,255,.94);border:1px solid rgba(226,232,240,.95);box-shadow:0 8px 22px rgba(15,23,42,.08);touch-action:none;scrollbar-width:none}
        ...
        #logyq-warehouse,#logyq-bank-trash{display:flex;position:fixed;z-index:30;width:44px;height:44px;bottom:calc(max(8px,env(safe-area-inset-bottom)) + 62px)}
        #logyq-warehouse{left:10px;right:auto;top:auto}
        #logyq-bank-trash{right:10px;left:auto;top:auto}
      ...
      @media (orientation:landscape) and (max-width:700px),(orientation:landscape) and (pointer:coarse) and (max-width:1200px),(orientation:landscape) and (hover:none) and (max-width:1200px){
        ...
        #Dock,#Dock.dock-left{box-sizing:border-box;left:max(8px,env(safe-area-inset-left));right:auto;top:max(8px,env(safe-area-inset-top));bottom:max(8px,env(safe-area-inset-bottom));width:148px;height:auto;min-height:0;max-height:none;overflow-x:hidden;overflow-y:auto;flex-direction:column;align-items:stretch;touch-action:none}
        #Dock .chip,#Dock.dock-left .chip{touch-action:none;width:100%;max-width:100%}
        #logyq-map-title{left:calc(max(8px,env(safe-area-inset-left)) + 164px)}
        #logyq-warehouse,#logyq-bank-trash{left:calc(max(8px,env(safe-area-inset-left)) + 164px);right:auto}
