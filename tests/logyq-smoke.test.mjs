...
test('LOGYQ phone shell keeps Fit, hides Trash, and can edit a selected card', async () => {
  ...
  assert.ok(cluster.width < 80, `corner cluster width ${cluster.width} should stay a rail`)
  assert.ok(cluster.x > 280, `corner cluster x ${cluster.x} should sit on the right`)
