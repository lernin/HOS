...
test('LOGYQ phone smite cake parks a thumb, counts mercy, and banks only the amber path', async () => {
  ...
  assert.ok(await page.evaluate(() => window.LOGYQPreview.gestures.smite.mercy.remaining < 14000), 'a child cancel does not restart the parent clock')
