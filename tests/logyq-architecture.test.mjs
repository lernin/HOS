...
test('isolated copy retains the v161 engine markers and working controls', () => {
  ...
  assert.match(preview, /logyq_handedness_v1/)
  assert.match(html, /id="logyqHandRight"/)
  assert.match(html, /id="logyqHandLeft"/)
...
test('preview fragments concatenate to the served enhancement without edits', () => {
  ...
  assert.match(assembled.source, /logyq_handedness_v1/)
})
