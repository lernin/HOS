...
for(const view of views){await page.evaluate(v=>window.villageQA.view(v),view);await page.waitForTimeout(1200);await page.screenshot({path:`${output}/${view}.png`})}
...
await page.screenshot({path:`${output}/phone-spawn.png`})
