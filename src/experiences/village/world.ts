...
export const paths: Path[] = [
  ...
  },
  {
    ...
    points: [
      p(-39, 19, -10.2), p(-39, 19, -9.2), p(-35, 19, -9.2), p(-32, 19, -8.6), p(-29, 19, -8.8),
      p(-27, 18.8, -10.5), p(-27, 18.5, -13), p(-21, 17.5, -16), p(-13, 16, -20),
      p(-4, 14.5, -23.5), p(6, 12.5, -26), p(15, 10.5, -28), p(22, 9, -29), p(26, 8, -29.8),
    ],
    width: 3.5,
    kind: 'bridge',
    rails: true,
