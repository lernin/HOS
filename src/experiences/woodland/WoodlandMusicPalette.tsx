...
export function WoodlandMusicPalette({ratings,activeId,onRate,onToggle}:{ratings:MusicRatings;activeId:string|null;onRate:(id:string,rating:MusicRating)=>void;onToggle:(id:string)=>void}){
  ...
  return <section className="woodland-music">
    <div className="woodland-music-heading">
      <div><h3>Music palette</h3><p>Play one, then rate it. Three-star favorites rise to the top. Zero-star progressions never play.</p></div>
