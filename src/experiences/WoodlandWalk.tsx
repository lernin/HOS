...
export function WoodlandWalk({onBack}:{onBack:()=>void}){
  ...
  return <main className="woodland">
    ...
    <WoodlandMiniMap position={mapPosition} yaw={mapYaw} onBack={onBack}/><header className="woodland-bar"><span>WOODLAND <small>A place to wander</small></span><button onClick={settings}>Sound & settings</button></header>
