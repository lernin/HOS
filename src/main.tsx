    ...
    <main className="shell hub-shell" data-theme={theme} style={styleVars}>
      ...
      <section className="experience-grid">
        ...
        <article className="experience-card">
          ...
          <span className="experience-copy"><strong>Melody Lab</strong><small>Audition compatible themes for Hearth, Wonder, Adventure, Mystery, Triumph, and the other musical colors with orchestral accompaniment. Rank what you love.</small></span>
